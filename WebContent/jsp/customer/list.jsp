										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/customer_edit.action?cust_id=<s:property value="#c.cust_id"/>">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/customer_delete.action?cust_id=<s:property value="#c.cust_id"/>">删除</a>
													</TD>
												</TR>
												</s:iterator>
											</TBODY>
