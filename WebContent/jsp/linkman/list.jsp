									...
									<TD height=25>
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD><s:textfield theme="simple" name="lkm_name"
															cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50" />
													</TD>
													<TD>联系人性别：</TD>
													<TD><s:select theme="simple" name="lkm_gender"
															list="#{'1':'男','2':'女'}" headerKey=""
											...
											<TBODY>
												...
												<s:iterator value="list">
													<TR
														...
														<TD><s:if test='lkm_gender == "1"'>
															男
														</s:if> <s:elseif test='lkm_gender == "2"'>
															女
														</s:elseif></TD>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV style="LINE-HEIGHT: 20px; HEIGHT: 20px; TEXT-ALIGN: right">
												共[<B><s:property value="totalCount" /></B>]条记录,[<B><s:property value="totalPage" /></B>]页 ,每页显示 <select name="pageSize" onchange="to_page()">
													<option value="3"
